...
parser.add_argument('--path',default="Data/m3cot_gpt3.5_standard_3_QCM_A.jsonl",type=str)
...
if __name__=='__main__':
    ...
    for output in outputs:
        ...
        output.update({"accuracy":o_acc})
        with open(f"{path[:-6]}_accuracy.jsonl",'a') as f:
